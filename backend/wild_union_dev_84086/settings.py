"""
Django settings for wild_union_dev_84086 project.
...
ROOT_URLCONF = 'wild_union_dev_84086.urls'
...
WSGI_APPLICATION = 'wild_union_dev_84086.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wild_union_dev_84086 API",
    "DESCRIPTION": "API documentation for wild_union_dev_84086 App",
    "VERSION": "v1",
}
